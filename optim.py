"""
code from:
https://github.com/hwk0702/keras2torch/blob/main/Computer_Vision/Gradient_Centralization_for_Better_Training_Performance
/optims.py
"""
...
def get_opt_module(opt_name):
    if opt_name in globals():
        return globals()[opt_name]
    else:
        from importlib import import_module
        return getattr(import_module("torch.optim"), opt_name)


if __name__ == '__main__':
    print('get Adam_GC:', get_opt_module('Adam_GC') == Adam_GC)
    print('get torch optim Adam:', get_opt_module('Adam') == torch.optim.Adam)
